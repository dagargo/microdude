...
You can easily install them by running `sudo apt-get install make python3 python3-setuptools python3-mido python3-mock python3-rtmidi python3-setproctitle gettext`.
